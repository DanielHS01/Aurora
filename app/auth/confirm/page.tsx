...
export default function ConfirmEmailPage() {
  ...
  const handleConfirm = useCallback(async () => {
    ...
    // Sesión ya activa (las cookies quedaron sincronizadas por el
    // cliente de Supabase). Ahora sí podemos crear el negocio pendiente.
    try {
      await completeBusinessSetupAction();
    } catch (err) {
      // No bloqueamos la confirmación por esto — el usuario ya quedó
      // autenticado; el negocio se puede completar después si falla.
